...
public class mp_graph_init extends AppCompatActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mp_graph_init);
                 ...
                 count=new CountDownTimer(((timer_sec+1)*1000), 500) { // adjust the milli seconds here
                     ...
                     public void onTick(long millisUntilFinished) {
                         ...
                         if(insert_clicked==1){
                             ...
                             if(run_sec>=10){
                                 ...
                                 Toast.makeText(getBaseContext(), "Insert the Sensor probe and then press the INSERT key.", Toast.LENGTH_LONG).show();
								 try {
                     ...
                     public void onFinish() {
                         ...
                         run.setBackgroundResource(R.drawable.btn_gray);
                                 ...
                                 Intent it = new Intent(mp_graph_init.this, mp_graph.class);
                                 startActivity(it);
                                 finish();
    ...
    private void openAlert(final Button b1,final Button b2,String s,final String s1,final String s2) {
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(mp_graph_init.this);
        ...
        alertDialogBuilder.setNeutralButton("Generate Report",new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog,int id) {
                ...
                Intent it = new Intent(mp_graph_init.this, pic_report.class);
                startActivity(it);
                finish();
    ...
    public void onBackPressed() {
        ...
        super.onBackPressed();
        Intent it = new Intent(mp_graph_init.this, time_select.class);
        startActivity(it);
        finish();
    }
