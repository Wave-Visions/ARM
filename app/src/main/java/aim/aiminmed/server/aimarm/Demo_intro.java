...
public class Demo_intro extends AppCompatActivity implements Animation.AnimationListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll_main = (LinearLayout) findViewById(R.id.intro_lay);//Main Screen layout
        ll = (LinearLayout) findViewById(R.id.intro_lay_up);//Upper layout for images
        ll_down = (LinearLayout) findViewById(R.id.intro_lay_down);//Lower layout for text
        ...
        summary.setText("In anorectal manometry, a thin tube, called a manometry probe, is inserted into the anal canal and slowly withdrawn. The probe is attached to a pressure transducer that measures the pressures exerted by the anal sphincter muscles, which relax and contract to control bowel movements.");
        ...
        FloatingActionButton pre = (FloatingActionButton) findViewById(R.id.pre);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Intent i = new Intent(Demo_intro.this,Demo_intro.class);
                //startActivity(i);
               // finish();
        ...
        if(animation == an_fade_out){
            ...
            switch(process){
                ...
                case 4:
                    ...
                    break;
                case 5:
                    Intent i = new Intent(Demo_intro.this,Splash.class);
                    startActivity(i);
                    finish();
                    break;
            }
